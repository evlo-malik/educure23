  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-indigo max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <li>
              ...
              in this Agreement) refers to Educure.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Educure, accessible from <a href="https://educure.io/" className="text-blue-600 hover:text-blue-800">https://educure.io/</a>
            </li>
            <li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">Opt-out of Marketing Communications</h3>
          <p className="mb-4">
            You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or instructions 
            provided in any email we send or by contacting us directly.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We use Stripe as our third-party payment processor to handle payments made through our website. When you make a purchase 
            or donation on our site, we collect necessary information to complete the transaction, including your name, billing 
            address, and payment details. However, we do not store sensitive payment information such as credit card numbers on our 
            servers. All payment information is processed securely through Stripe&apos;s system.
          </p>
          <p className="mb-4">
            By using our website to make a payment, you acknowledge and agree that your payment information will be processed by 
            Stripe according to their privacy policy and terms of service. Stripe uses advanced encryption methods and adheres to 
            strict security standards (including PCI-DSS compliance) to protect your payment data.
          </p>
          <p className="mb-4">
            For more information on how Stripe handles your personal data, please refer to their <a href="https://stripe.com/gb/privacy" className="text-blue-600 hover:text-blue-800">https://stripe.com/gb/privacy</a>
          </p>

          <h3 className="text-xl font-semibold mb-3">Data Collected by Stripe</h3>
          <p className="mb-4">
            Stripe may collect personal information such as:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>Name</li>
            <li>Email address</li>
          ...
          <p className="mb-4">
            We do not control the data collected by Stripe. This information is used solely for the purpose of processing payments, 
            preventing fraud, and complying with legal and regulatory requirements.
          </p>

          <h3 className="text-xl font-semibold mb-3">How We Use Your Data</h3>
          <p className="mb-4">
            We use the payment information provided to:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>Process and fulfill your transactions</li>
            <li>Provide customer support related to your payments</li>
            <li>Communicate with you about your order or payment status</li>
          </ul>

          <h3 className="text-xl font-semibold mb-3">Data Security</h3>
          <p className="mb-4">
            Stripe uses industry-standard encryption and security measures to protect your personal and payment information. We do 
            not have access to your full credit card details, which are securely handled and stored by Stripe.
          </p>

          <h3 className="text-xl font-semibold mb-3">Retention of Payment Information</h3>
          <p className="mb-4">
            We do not retain your payment details after the transaction is complete. However, Stripe may retain certain transaction 
            data for accounting, regulatory, or fraud prevention purposes. For more details on Stripe’s data retention practices, 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            By visiting this page on our website: <a href="https://educure.io/support" className="text-blue-600 hover:text-blue-800">https://educure.io/support</a>
          </p>
        </section>
      </div>
    </div>
